...
4. server state는 TanStack Query 기준으로 query key, query options, mutation options, invalidation 책임을 분리합니다.
...
- mutation 성공 후 stale한 list/detail/infinite query를 invalidation합니다.
