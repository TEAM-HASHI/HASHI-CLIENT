...
| size | button box | Tailwind utility | 주요 용도                                              |
| ---- | ---------: | ---------------- | ------------------------------------------------------ |
| `xs` |     `24px` | `size-6`         | topbar의 뒤로가기, 공유 같은 기본 아이콘 액션          |
| `md` |     `40px` | `size-10`        | 수정 버튼처럼 명확한 touch box가 있는 icon-only action |
...
- size:
  - `xs`: `size-6` (`24px x 24px`)
  - `md`: `size-10` (`40px x 40px`)
