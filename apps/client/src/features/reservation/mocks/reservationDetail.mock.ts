import { formatDotDateTime, formatMonthDayTime } from '@/shared/utils'
...
export const reservationProgressSteps = [
  {
    ...
    requestedAt: formatMonthDayTime(new Date('2026-06-21T13:44:00')),
    status: 'completed',
  },
  {
    id: 'contacting',
    ...
    requestedAt: formatMonthDayTime(new Date('2026-06-22T13:44:00')),
    status: 'completed',
  },
  {
    id: 'confirmed',
