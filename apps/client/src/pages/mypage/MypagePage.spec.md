...
- 내가 찜한 식당과 계정 관련 기능은 MVP 범위에서 제외합니다.
- 프로필 수정 버튼은 `/profile/edit`로 이동하고, 저장 API는 후속 작업으로 남깁니다.
...
- [x] 프로필 수정 버튼은 `/profile/edit`로 이동합니다.
- [x] 사용 가능 포인트를 보여줍니다.
...
- 수정 버튼을 누르면 `ROUTES.profileEdit`로 이동합니다.
...
- 프로필 수정 버튼은 `/profile/edit`로 이동해야 합니다.
...
- 프로필 수정 버튼 클릭 시 `/profile/edit`로 이동하는지 확인
