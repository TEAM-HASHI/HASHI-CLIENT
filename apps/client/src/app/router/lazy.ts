...
const NoticesPage = lazyRoute(() => import('@/pages/notices'))
const NoticeDetailPage = lazyRoute(() => import('@/pages/noticeDetail'))
...
export const lazyPages = {
  ...
  notices: () => lazyPage(NoticesPage),
  noticeDetail: () => lazyPage(NoticeDetailPage),
