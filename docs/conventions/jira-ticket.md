...
이 문서는 HASHI Client 팀에서 Jira 이슈를 만들고 작업 흐름에 연결하는 기준을 정리합니다.
...
```markdown
HASHI-18 프로젝트 초기 세팅
└ HASHI-17 [INIT] Tailwind CSS 초기 세팅
```
...
- 이슈 키는 `HASHI-번호` 형식을 유지합니다.
- 작업 요약은 영어 소문자와 하이픈을 사용합니다.

예시는 다음과 같습니다.

```markdown
init/HASHI-17-tailwind-setting
feat/HASHI-24-login-page
fix/HASHI-31-button-click-event
refactor/HASHI-42-auth-logic
style/HASHI-55-input-component
```
...
브랜치: init/HASHI-17-tailwind-setting
